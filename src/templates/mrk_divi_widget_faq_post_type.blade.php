    ...
    @if($enable_groups == 'on')
        @foreach($terms as $term)
            <?php
                ...
                $shortcode[]  = sprintf('[et_pb_text admin_label="Text" background_layout="light" text_orientation="left" use_border_color="off" border_color="#ffffff" border_style="solid"]%s[/et_pb_text]', $term->name);
